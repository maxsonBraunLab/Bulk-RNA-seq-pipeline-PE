...
# get rid of zeros in rld matrix so that pheatmap will work
rld_nonzero <- assay(rld)[apply(assay(rld), MARGIN = 1, FUN = function(x) sd(x) != 0), ]

hm <- pheatmap(rld_nonzero, show_rownames=F, clustering_distance_rows = "correlation", 
